...
class Column2Skills extends React.Component {
    constructor() {
        ...
        this.state = {
            // skill:['Skill', '技能'],
            attackSkills:['Attack Skills', '攻击技能'],
            elementSkills:['Element Skills', '属性技能'],
            atkEleSkills:['Atk&Ele Skills', '攻击属性技能'],
            level:['Level', '等级'],
            //
            ...
            mailOfHellfireRed:['Mail of Hellfire (Red)', '业铠修罗（红书）'],
            fortify:['Fortify', '不屈'],
            ...
            mailOfHellfireBlue:['Mail of Hellfire (Blue)', '业铠修罗（蓝书）'],
        ...
        return (
            <div className="sixteen wide mobile eight wide tablet four wide computer column">
                <table onChange={e => this.props.handleSkills(e)} className="ui compact table">
                    <thead><tr><th>{this.state.atkEleSkills[this.props.languageVersion]}</th><th>{this.state.level[this.props.languageVersion]}</th></tr></thead>
                    <tbody>
                    ...
                    <thead><tr><th>{this.state.elementSkills[this.props.languageVersion]}</th><th>{this.state.level[this.props.languageVersion]}</th></tr></thead>
                    <tbody>
                    ...
                    <thead><tr><th>{this.state.attackSkills[this.props.languageVersion]}</th><th>{this.state.level[this.props.languageVersion]}</th></tr></thead>
                    <tbody>
