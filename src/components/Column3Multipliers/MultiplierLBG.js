...
class MultiplierLBG extends React.Component {
    constructor() {
        super();
        this.state = {
            //
            ...
            <div className="sixteen wide mobile eight wide tablet four wide computer column" >
                <table className="table ui compact">
                    ...
                    <tbody onChange={this.props.handleFinalAtkEleMultipliersUpdate}>
                        ...
                        <tr><td>{this.state.fanningManeuver[this.props.languageVersion]}</td><td><input className='element-damage final-atk-multi'onChange={this.props.handleDamageMultipliersUpdate} type="number" placeholder="1" step="0.1" min='1' max='1.1' size="6"/></td></tr>
                    </tbody>
